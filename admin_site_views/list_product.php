                    ...
                    <div class="px-8 font-[sans-serif] overflow-x-auto">
                        <div class="mb-4 flex justify-between">
                            ...
                            <a href="new_product.php"
                                class="text-sm text-white bg-green-500 hover:bg-green-700 py-2 px-4 rounded">Add
                                Product</a>
                        </div>
                        <div class="mb-4 flex justify-start">
                            <form method="GET" action="" class="flex items-center">
                                <input type="text" name="search" placeholder="Search..."
                                    class="text-sm text-gray-500 border border-gray-400 rounded h-7 px-2 outline-none">
                                <button type="submit"
                                    class="text-sm text-white bg-blue-500 hover:bg-blue-700 py-1 px-2 rounded ml-2">Search</button>
                            </form>
                        </div>
                        <div
                            ...
                            <table class="w-full text-left table-auto min-w-max">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="p-4 border-b border-slate-300 bg-slate-50">
                                            <p class="block text-sm font-normal leading-none text-slate-500">Description
                                            </p>
                                        </th>
                                        <th class="p-4 border-b border-slate-300 bg-slate-50">
                                    ...
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-4 border-b border-slate-200">
                                            <a href="edit_product.php?id=<?= $row["id"] ?>"
                                                class="text-sm text-white bg-blue-500 hover:bg-blue-700 py-1 px-2 rounded">Edit</a>
                                            <a href="delete_product.php?id=<?= $row["id"] ?>"
                                                class="text-sm text-white bg-red-500 hover:bg-red-700 py-1 px-2 rounded ml-2">Delete</a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                    <?php else: ?>
