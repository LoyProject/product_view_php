                            ...
                            <table class="w-full text-left table-auto min-w-max">
                                ...
                                <tbody>
                                    ...
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-4 border-b border-slate-200">
                                            <a href="edit_product.php?id=<?= $row["id"] ?>" class="text-sm text-white bg-blue-500 hover:bg-blue-700 py-1 px-2 rounded">
                                                Edit
                                            </a>
                                            <a href="delete_product.php?id=<?= $row["id"] ?>" class="text-sm text-white bg-red-500 hover:bg-red-700 py-1 px-2 rounded ml-2">
                                                Delete
                                            </a>
                                        </td>
                                    </tr>
