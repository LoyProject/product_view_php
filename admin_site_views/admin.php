                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php while ($row = $result->fetch_assoc()): ?>
                                            <tr class ="text-sm">
                                                ...
                                                <td class="px-4 border-b w-2/5 break-words whitespace-normal"><?= $row["description"] ?>
                                                </td>
                                                <td class="px-4 border-b w-1/5"><img src="../images/<?= $row["image"] ?>" alt="Product Image" class="w-16 h-16"></td>
                                ...
                                <div class="flex items-center max-md:mt-4">
                                    ...
                                    <ul class="flex space-x-1 ml-2">
                                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                            <li class="flex items-center justify-center cursor-pointer text-sm w-7 h-7 <?= $page == $i ? 'bg-[#007bff] text-white' : 'text-gray-500' ?> rounded" onclick="window.location.href='?page=<?= $i ?>&limit=<?= $limit ?>'">
                                                <?= $i ?>
                                            </li>
                                        <?php endfor; ?>
                                    </ul>
                        ...
                        <div id="editProductModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center hidden">
                            <div class="bg-white p-6 rounded shadow-lg w-full max-w-md">
                                ...
                                <form id="updateForm" onsubmit="submitForm(event)">
                                    ...
                                    <div class="mb-4">
                                        <label for="update-image-preview" class="block text-sm font-medium">Current Image</label>
                                        <img id="update-image-preview" class="w-32 h-32 object-cover mb-2">
                                        <input type="file" id="update-image" name="update-image" class="w-full border rounded px-3 py-2" accept="image/*">
                                    </div>
