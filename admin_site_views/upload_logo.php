...
<head>
    ...
    <script>
        function handleImageChange(event) {
            ...
            const logoImageLabel = document.getElementById('logo-image');
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    logoImageLabel.classList.add('hidden');
            ...
            <div class="main-content w-full overflow-auto p-6">
                <div class="container-xl mx-auto">
                    <div class="item-center">
                        ...
                        <div class="flex">
                            <label id="lable-image" class="block hover:border-red-500 border-2 border-dashed border-slate-100 shadow-sm w-full px-2 h-52 rounded text-slate-500 cursor-pointer mx-auto flex flex-col justify-center items-center">
                                ...
                                <label class=" font-md text-slate-500" id="logo-image">Upload Image</label>
                                <span id="file-name" class="text-xs font-medium text-gray-400 mt-2">
