            ...
            <div class="main-content w-full overflow-auto p-6">
                <div class="container-xl mx-auto">
                    <div class="flex justify-between items-center">
                        <h2 class="py-4 text-2xl font-bold">Product List</h2>
                    ...
                    <table class="w-full table-auto border-collapse">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="px-4 text-xs border-b border-slate-200 w-0/5"> <?= $row['id'] ?> </td>
                                <td class="px-4 text-xs border-b border-slate-200 w-1/5">
                                    <?= htmlspecialchars($row['name']) ?>
                                </td>
                                <td class="px-4 text-xs border-b border-slate-200 w-2/5">
