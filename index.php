            ...
            <div class="px-4 sm:px-10">
                <div id="default-carousel" class="relative w-full mt-24 relative z-10" data-carousel="slide">
                    ...
                    <div class="relative h-auto overflow-hidden rounded-lg md:h-96">
                        ...
                        <div class="<?= $index === 0 ? 'absolute inset-0 flex duration-700 ease-in-out' : 'hidden absolute inset-0 flex duration-700 ease-in-out' ?>"
                            data-carousel-item="<?= $index === 0 ? 'active' : '' ?>">
                            <img src="<?= htmlspecialchars($slideshowPath . $slideImage) ?>"
                                class="block w-full h-full object-cover" alt="Slide <?= $index + 1 ?>">
                        </div>
                        <?php endforeach; ?>
                    </div>
                    <!-- Slider indicators -->
